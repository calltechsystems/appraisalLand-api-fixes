...
const Index = ({userId}) => {
  ...
  useEffect(() => {
    ...
    toast.loading("Fetching the User's plan");
    axios
      ...
      .then((res) => {
        let allPlans = res.data.data.transactions.$values;
        if(allPlans.length > 0){
          setData(allPlans);
        }
        else{
          toast.error("No Plan found for this user");
          setData([]);
        }
      })
      .catch((err) => {
              ...
              <div className="row align-items-center">
                <div className="col-lg-12 col-xl-12 text-center mt-4">
                  <div className="style2 mb30-991">
                    <h2 className="heading-forms">Plan Detail History</h2>
                  </div>
                </div>
              </div>
              {/* End .row */}
