...
export default function Exemple({
  ...
  //----
  const openBrokerViewModal = (brokeruserId) => {
    const brokerInfo =
      allBrokers.filter((broker) => broker.userId == brokeruserId) || [];
    if (brokerInfo.length) {
      setSelectedBroker({ ...brokerInfo[0] });
            ...
            broker: (
              <a href="#">
                <button
                  ...
                  onClick={() => openBrokerViewModal(property.userId)}
                >
