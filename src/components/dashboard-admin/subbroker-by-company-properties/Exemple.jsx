...
export default function Exemple({
  ...
  const openBrokerModalView = (userId, brokerageCompanyInfo, userType) => {
    openModalBroker({ ...brokerageCompanyInfo }, userType);
  };
  ...
  useEffect(() => {
      ...
      properties.map((propInfo, index) => {
        ...
        const brokerInfo = { ...propInfo.broker };
        const brokerageCompanyInfo = { ...propInfo.brokerage };
        ...
        const isAccordingToSelectedName = isLikeUserSearchedType(brokerageCompanyInfo);
            ...
            broker: (
              <a href="#">
                <button
                  ...
                  onClick={() => openBrokerModalView(property.userId, brokerInfo, 1)}
                >
                  {(brokerInfo.firstName == '' || !brokerInfo.firstName) ? "N.A." : `${brokerInfo.firstName} ${brokerInfo.lastName}`}
                </button>
              </a>
            ),
            brokerage: (
              <a href="#">
                <button
                  ...
                  onClick={() => openBrokerModalView(property.userId, brokerageCompanyInfo, 2)}
                  >
                    {(brokerageCompanyInfo.firstName == '' || !brokerageCompanyInfo.firstName) ? "N.A." : `${brokerageCompanyInfo.firstName} ${brokerageCompanyInfo.lastName}`}
                  </button>
              </a>
            ),
            plan: (
