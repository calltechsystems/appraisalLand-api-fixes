  ...
  useEffect(() => {
    const filterProperties = (propertys, userNameSearch) => {
      ...
      const filteredProperties = propertys.filter((prop) => {
        ...
        const brokerage = prop.brokerage;
        if(brokerage?.assistantFirstName){

          const includesFirstName = 
          String(brokerage.assistantFirstName).toLowerCase().includes
          (searchString);

          const includesLastName = 
          String(brokerage.assistantLastName).toLowerCase()
                                ...
                                <div className="row">
                                  <div className="col-lg-12 text-center">
                                    <h1 className=" text-color mt-1">
                                      {typeView == 1 ? 'Broker' : 'Brokerage'} {" "}Details
                                    </h1>
                                  </div>
                                </div>
                                <div
